...
}`}),(0,i.jsxs)(l,{children:[(0,i.jsx)("strong",{children:"stateMachines"})," değeri bileşenin sayfasında yazan değerle birebir aynı olmalıdır. Yanlış yazarsanız animasyon oynar ama etkileşimler çalışmaz."]})]}),(0,i.jsxs)("section",{children:[(0,i.jsx)(t,{step:4,children:"Sayfanızda Kullanın"}),(0,i.jsx)(s,{lang:"tsx",code:`import RiveButton from "@/components/RiveButton";
...
</script>`})]}),(0,i.jsxs)("section",{children:[(0,i.jsx)(t,{step:4,children:"Responsive Ayarları"}),(0,i.jsx)("p",{className:"text-white/60 mb-4",children:"Canvas'ın responsive olması için stil ayarlarını şu şekilde yapın:"}),(0,i.jsx)(s,{lang:"css",code:`#rive-anim {
  width: 100%;
  max-width: 400px;
  height: auto;
  aspect-ratio: 1 / 1;
}`})]})]})},html:function(){return(0,i.jsxs)("div",{className:"space-y-10",children:[(0,i.jsxs)("section",{children:[(0,i.jsx)(t,{step:1,children:"Rive JS Runtime'ı Ekleyin"}),(0,i.jsxs)("p",{className:"text-white/60 mb-4",children:["HTML dosyanızın ",(0,i.jsx)("code",{className:"text-[#ff2b73]",children:"<head>"})," bölümüne:"]}),(0,i.jsx)(s,{lang:"html",code:'<script src="https://unpkg.com/@rive-app/canvas@latest"></script>'})]}),(0,i.jsxs)("section",{children:[(0,i.jsx)(t,{step:2,children:"Canvas Elementi Oluşturun"}),(0,i.jsx)(s,{lang:"html",code:'<canvas id="my-rive" width="500" height="500"></canvas>'})]}),(0,i.jsxs)("section",{children:[(0,i.jsx)(t,{step:3,children:"Rive'ı Başlatın"}),(0,i.jsx)(s,{lang:"html",code:`<script>
...
}`})]}),(0,i.jsxs)("section",{children:[(0,i.jsx)(t,{step:4,children:"Etkileşim Ekleyin"}),(0,i.jsx)("p",{className:"text-white/60 mb-4",children:"Mouse tıklamasıyla trigger tetiklemek için:"}),(0,i.jsx)(s,{lang:"csharp",code:`void Update()
{
...
}`}),(0,i.jsx)(r,{children:"Trigger, Boolean ve Number input isimlerini bileşen sayfasındaki State Machine bilgilerinden öğrenebilirsiniz."})]})]})},android:function(){return(0,i.jsxs)("div",{className:"space-y-10",children:[(0,i.jsxs)("section",{children:[(0,i.jsx)(t,{step:1,children:"Gradle Bağımlılığını Ekleyin"}),(0,i.jsxs)("p",{className:"text-white/60 mb-4",children:["Modül seviyesindeki ",(0,i.jsx)("code",{className:"text-[#ff2b73]",children:"build.gradle"})," dosyanıza:"]}),(0,i.jsx)(s,{lang:"groovy",code:`dependencies {
    implementation "app.rive:rive-android:9.+"
    // Kotlin kullanıyorsanız:
    // implementation "app.rive:rive-android-kotlin:9.+"
}`})]}),(0,i.jsxs)("section",{children:[(0,i.jsx)(t,{step:2,children:".riv Dosyasını Ekleyin"}),(0,i.jsxs)("p",{className:"text-white/60 mb-4",children:["Dosyayı ",(0,i.jsx)("code",{className:"text-[#ff2b73]",children:"res/raw/"})," klasörüne koyun:"]}),(0,i.jsx)(s,{code:`app/
└── src/main/
    └── res/
        └── raw/
            └── button_hover.riv`})]}),(0,i.jsxs)("section",{children:[(0,i.jsx)(t,{step:3,children:"Layout XML'e Ekleyin"}),(0,i.jsx)(s,{lang:"xml",code:`<app.rive.runtime.core.RiveAnimationView
    android:id="@+id/rive_view"
    android:layout_width="300dp"
    android:layout_height="120dp"
    app:rivResource="@raw/button_hover"
    app:riveStateMachine="State Machine 1"
    app:riveAutoPlay="true" />`})]}),(0,i.jsxs)("section",{children:[(0,i.jsx)(t,{step:4,children:"Java ile Etkileşim"}),(0,i.jsx)(s,{lang:"java",code:`RiveAnimationView riveView = findViewById(R.id.rive_view);
...
export default function CustomButton() {
  const { RiveComponent, rive } = useRive({
    ...
    autoplay: true,
    onLoad: () => {
      // Dosya y\xfcklendiğinde yazıyı değiştir
      rive?.setTextRunValue("ButtonText", "Satın Al");
    }
  });

  return <div style={{ width: 300, height: 100 }}><RiveComponent /></div>;
}`})]}),(0,i.jsxs)("div",{children:[(0,i.jsxs)("h3",{className:"text-xl font-bold mb-3 flex items-center gap-2",children:[(0,i.jsx)("span",{className:"text-[#ff2b73]",children:"3."})," HTML / JS / Wix İçinde Yazıyı Değiştirme"]}),(0,i.jsx)("p",{className:"text-white/60 mb-3",children:"Rive örneğini oluşturduğunuzda dönen objeyi kullanarak aynı işlemi yapabilirsiniz:"}),(0,i.jsx)(s,{lang:"javascript",code:`const r = new rive.Rive({
  src: "animasyon.riv",
  canvas: document.getElementById("canvas"),
  stateMachines: "State Machine 1",
  onLoad: () => {
    // Yazıyı dinamik olarak değiştir
    r.setTextRunValue("ButtonText", "G\xf6nder");
  }
});`})]})]}),(0,i.jsxs)(r,{children:["Hazırlayacağınız eğitim videolarında, Rive editöründeki ",(0,i.jsx)("strong",{children:"Text Run"})," alanına isim vermeyi ve ardından koddaki ",(0,i.jsx)("code",{children:'setTextRunValue("Isim", "Yeni Deger")'})," kullanımını göstermeniz, kullanıcılarınızın işini çok kolaylaştıracaktır."]})]}),(0,i.jsxs)("div",{className:"mt-8 p-5 rounded-2xl border border-yellow-500/20 bg-yellow-500/5 text-sm text-white/60",children:[(0,i.jsx)("strong",{className:"text-yellow-400",children:"Not:"})," Giriş yapmadan bileşenlerin yalnızca önizlemelerini görebilirsiniz. Kaynak kodlara ve .riv dosyalarına erişebilmek için ücretsiz üyelik oluşturmanız gerekmektedir."]})]})})}])}]);