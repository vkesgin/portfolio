(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,62516,e=>{"use strict";var t=e.i(12033),i=e.i(72339),s=e.i(50654);let r=[{id:"react",label:"React",icon:"⚛",note:"Next.js / Vite"},{id:"js",label:"JavaScript",icon:"🌐",note:"Vanilla / HTML"},{id:"rn",label:"React Native",icon:"📱",note:"iOS & Android"},{id:"flutter",label:"Flutter",icon:"🐦",note:"Dart / Multi"}];e.s(["default",0,function(){let[e,a]=(0,i.useState)([]),[l,n]=(0,i.useState)(!0),[o,c]=(0,i.useState)(null),[d,x]=(0,i.useState)("react"),[h,m]=(0,i.useState)(!1),[f,p]=(0,i.useState)("all"),[u,b]=(0,i.useState)(null);(0,i.useEffect)(()=>{async function e(){let e=localStorage.getItem("ui_token");if(e)try{let t=await fetch("https://vk-portfolio-api.vkesgin38.workers.dev/api/ui/auth/me",{headers:{Authorization:`Bearer ${e}`}});if(t.ok){let e=await t.json();b(e.user)}}catch(e){}}(async function(){try{let e=await fetch("https://vk-portfolio-api.vkesgin38.workers.dev/api/projects?category=uilib");e.ok&&a(await e.json())}catch(e){console.error("Veri çekilemedi:",e)}finally{n(!1)}})(),e()},[]);let v=u?.plan==="PRO";u&&u.id;let g=async e=>{try{await navigator.clipboard.writeText(e),m(!0),setTimeout(()=>m(!1),2e3)}catch(e){}},w=(0,i.useMemo)(()=>{try{return o?.tags?JSON.parse(o.tags):{}}catch{return{}}},[o]),j=(0,i.useMemo)(()=>o?.image_url?.split("/").pop()??"animation.riv",[o]),y=(0,i.useMemo)(()=>o?function(e,t,i,s){let r=t.artboard||"",a=(t.stateMachines??(t.statemachine?[t.statemachine]:[]))[0]??"",l=t.inputs??[],n=l.filter(e=>0===e.type),o=a&&0===l.length,c=s.replace(/[^a-zA-Z0-9]/g,"")||"RiveComponent",d=i||"animation.riv";if("react"===e){let e=`"use client";
...
`;return r&&(e+=`  const ARTBOARD = "${r}";
`),a&&(e+=`  const STATE_MACHINE = "${a}";
`),e+=`
  const { rive, RiveComponent } = useRive({
    src: RIVE_FILE,
`,r&&(e+=`    artboard: ARTBOARD,
...
`;let s="fire"+t.name[0].toUpperCase()+t.name.slice(1);e+=`  const ${s} = () => { if (${i}) ${i}.fire(); };
`})):o&&(e+=`
