(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,62516,e=>{"use strict";var t=e.i(12033),i=e.i(72339),r=e.i(50654);let a=[{id:"react",label:"React",icon:"⚛",note:"Next.js / Vite"},{id:"js",label:"JavaScript",icon:"🌐",note:"Vanilla / HTML"},{id:"rn",label:"React Native",icon:"📱",note:"iOS & Android"},{id:"flutter",label:"Flutter",icon:"🐦",note:"Dart / Multi"}];e.s(["default",0,function(){let[e,s]=(0,i.useState)([]),[l,n]=(0,i.useState)(!0),[o,d]=(0,i.useState)(null),[c,x]=(0,i.useState)("react"),[h,m]=(0,i.useState)(!1),[u,b]=(0,i.useState)("all"),[f,p]=(0,i.useState)(null),[v,g]=(0,i.useState)(null),[w,y]=(0,i.useState)(null),[j,k]=(0,i.useState)(!1),[N,$]=(0,i.useState)(""),[_,M]=(0,i.useState)(""),[C,R]=(0,i.useState)(!1);(0,i.useEffect)(()=>{async function e(){let e=localStorage.getItem("ui_token");if(e)try{let t=await fetch("https://vk-portfolio-api.vkesgin38.workers.dev/api/ui/auth/me",{headers:{Authorization:`Bearer ${e}`}});if(t.ok){let e=await t.json();p(e.user),void 0!==e.user.remaining_downloads&&g(e.user.remaining_downloads)}}catch(e){}}(async function(){try{let e=await fetch("https://vk-portfolio-api.vkesgin38.workers.dev/api/projects?category=uilib");e.ok&&s(await e.json())}catch(e){console.error("Veri çekilemedi:",e)}finally{n(!1)}})(),e()},[]);let z=f?.plan==="PRO";f&&f.id;let S=async(e,t)=>{let i=localStorage.getItem("ui_token");if(!i)return!1;y(null),k(!0);try{let r=await fetch("https://vk-portfolio-api.vkesgin38.workers.dev/api/ui/download",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:JSON.stringify({component_id:e,download_type:t})}),a=await r.json();if(!r.ok)return y(a.error||"İndirme başarısız"),!1;return void 0!==a.remaining_downloads&&g(a.remaining_downloads),!0}catch{return y("Sunucu hatası"),!1}finally{k(!1)}},T=async(e,t)=>{if(!t||await S(t,"code"))try{await navigator.clipboard.writeText(e),m(!0),setTimeout(()=>m(!1),2e3)}catch(e){}},B=(0,i.useMemo)(()=>{try{return o?.tags?JSON.parse(o.tags):{}}catch{return{}}},[o]),A=(0,i.useMemo)(()=>o?.image_url?.split("/").pop()??"animation.riv",[o]),E=(0,i.useMemo)(()=>o?function(e,t,i,r,a){let s=t.artboard||"",l=(t.stateMachines??(t.statemachine?[t.statemachine]:[]))[0]??"",n=t.inputs??[],o=n.filter(e=>0===e.type),d=l&&0===n.length,c=r.replace(/[^a-zA-Z0-9]/g,"")||"RiveComponent",x=i||"animation.riv";if("react"===e){let e=`"use client";
